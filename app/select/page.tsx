...
export default function SelectPage() {
    ...
    const [selectedFrequency, setSelectedFrequency] = useState<string | null>("weekly");
    const { user } = useAuth();
    const router = useRouter();

    const handleFrequencyToggle = (frequencyId: string) => {
        setSelectedFrequency((prev) => (prev === frequencyId ? prev : frequencyId));
    };
    ...
    async function handleSavePreferences(e: FormEvent) {
        ...
        try {
            ...
            alert("Your newsletter preferences have been saved successfully!");
